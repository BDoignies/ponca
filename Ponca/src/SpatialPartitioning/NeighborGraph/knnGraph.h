...
namespace Ponca
{
    ...
    struct KnnGraphBuffers : public NeighborGraphBufferBase<_Traits>
    {
        ...
        /// \brief Helper constexpr defining the default number of neighbors in Knn graphs
        static constexpr int DefaultKInKnnGraph() { return 6; }
    ...
    public:
        ...
        PONCA_MULTIARCH_HOST inline KnnGraphBase(const KdTreeBase<KdTreeTraits>& _kdtree,
                                                 const int _k = Buffers::DefaultKInKnnGraph())
